# -*- coding: utf-8 -*-
#
# dbtools documentation build configuration file, created by
...
man_pages = [
    ('index', 'dbtools', u'dbtools Documentation',
...
texinfo_documents = [
  ('index', 'dbtools', u'dbtools Documentation',
   u'Jessica B. Hamrick', 'dbtools', 'Lightweight SQLite interface',
   'Miscellaneous'),
]
